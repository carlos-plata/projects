...
public class ReservationControllerTest {
	...
	public void getReservations() throws Exception {
		...
		mockRoomReservation.setLastName("Argento");
		mockRoomReservation.setFirstName("Charlie");
		...
		mockRoomReservation.setRoomName("Coolest Room");
		...
		this.mockMvc.perform(get("/reservations?date=2017-01-01")).andExpect(status().isOk())
				.andExpect(content().string(containsString("Argento, Charlie")));
	}
}
